...
Step 3: Create a project management like board that lets users keep track of to-do, in progress, complete. Also let users add categories with little icons to indicate what type of task it is. 
